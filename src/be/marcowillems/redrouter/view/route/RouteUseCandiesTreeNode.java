 ...
 */
public class RouteUseCandiesTreeNode extends RouteEntryTreeNode {

    private final JLabel lblInfo = new JLabel();
    private String text = "";
    private int availableWidth = 0;

    public RouteUseCandiesTreeNode(RouteTree tree, RouteUseCandies routeUseCandies) {
        super(tree, routeUseCandies, true);
