...
public class RouteFactory {
    ...
    private void initRedExaNidoRoute() {
        ...
        RouteSection rsStart = new RouteSection(route, "New Game");
        ...
        RouteSection rsParcel = new RouteSection(route, "Getting the Parcel to Oak");

        RouteSection rsRoute1A = new RouteSection(route, "Route 1");
        ...
        RouteSection rsViridianA = new RouteSection(route, "Viridian City");
        ...
        RouteSection rsRoute1B = new RouteSection(route, "Route 1");
        ...
        RouteSection rsPalletB = new RouteSection(route, "Pallet Town");
        ...
        RouteSection rsNido = new RouteSection(route, "Getting Nidoran!");

        RouteSection rsRoute1C = new RouteSection(route, "Route 1");
        ...
        RouteSection rsViridianB = new RouteSection(route, "Viridian City");
        ...
        RouteSection rsRoute22A = new RouteSection(route, "Route 22");
        // TODO: Catching entry!
        ...
        RouteSection rsViridianC = new RouteSection(route, "Viridian City");
        ...
        RouteSection rsViridianF = new RouteSection(route, "Viridian Forest");
        ...
        RouteSwapPokemon rspiridianF = new RouteSwapPokemon(route, new RouteEntryInfo("Swap Squirtle with Nidoran"), 0, 1);
        ...
        RouteSection rsPewter = new RouteSection(route, "Pewter City");
        ...
        RouteSection rsRoute3 = new RouteSection(route, "Route 3");
