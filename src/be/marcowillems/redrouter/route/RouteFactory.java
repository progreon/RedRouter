...
public class RouteFactory {
    ...
    private void initRedExaNidoRoute() {
        ...
        RouteSection rsStart = new RouteSection("New Game");
        ...
        RouteSection rsPalletA = new RouteSection("Pallet Town");
        ...
        RouteSection rsParcel = new RouteSection("Getting the Parcel to Oak");

        RouteSection rsRoute1A = new RouteSection("Route 1");
        ...
        RouteSection rsViridianA = new RouteSection("Viridian City");
        ...
        RouteSection rsRoute1B = new RouteSection("Route 1");
        ...
        RouteSection rsPalletB = new RouteSection("Pallet Town");
        ...
        RouteSection rsNido = new RouteSection("Getting Nidoran!");

        RouteSection rsRoute1C = new RouteSection("Route 1");
        ...
        RouteSection rsViridianB = new RouteSection("Viridian City");
        ...
        RouteSection rsRoute22A = new RouteSection("Route 22");
        // TODO: Catching entry!
        ...
        RouteSection rsViridianC = new RouteSection("Viridian City");
        ...
        RouteSection rsViridianF = new RouteSection("Viridian Forest");
        ...
        RouteSection rsPewter = new RouteSection("Pewter City");
        ...
        RouteSection rsRoute3 = new RouteSection("Route 3");
